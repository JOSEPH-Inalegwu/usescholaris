            ...
            <main className="min-h-screen flex flex-col md:flex-row bg-[#f9f9f9] text-[#2d3435] antialiased" style={{ fontFamily: 'Lora, serif' }}>
                ...
                <section className="w-full md:w-1/2 bg-white flex items-center justify-center p-10 md:p-16 min-h-screen relative shadow-2xl z-10 overflow-y-auto">
                    <motion.div
                        ...
                        className="w-full max-w-sm space-y-8 z-10 py-8"
                    >
                        <div className="space-y-1">
                            <h2 style={{ fontFamily: 'Merriweather, serif' }} className="text-3xl font-bold text-[#2d3435] tracking-tight">Create Account</h2>
                            <p style={{ fontFamily: 'Lora, serif' }} className="text-[#5a6061] text-sm font-medium">Join our academic community today.</p>
                        </div>
                        ...
                        >
                            ...
                            <span style={{ fontFamily: 'Lora, serif' }} className="text-sm font-bold text-[#2d3435]">
                                {isGoogleLoading ? 'Wait...' : 'Sign up with Google'}
                            </span>
                        </motion.button>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div className="space-y-1.5">
                                <label className="block text-[11px] font-bold text-[#5a6061] uppercase tracking-widest ml-1" htmlFor="name">
                                    Full Name
                                </label>
                                <input
                                    id="name"
                                ...
                                />
                                {errors.name && <p className="text-xs text-red-600 ml-1">{errors.name.message}</p>}
                            </div>
                            ...
                            <div className="space-y-1.5">
                                <label className="block text-[11px] font-bold text-[#5a6061] uppercase tracking-widest ml-1" htmlFor="password">
                                    Password
                                </label>
                                <input
                                    id="password"
                            ...
                            <div className="space-y-1.5">
                                <label className="block text-[11px] font-bold text-[#5a6061] uppercase tracking-widest ml-1" htmlFor="confirmPassword">
                                    Confirm Password
                                </label>
                                <input
                                    id="confirmPassword"
                            ...
                            >
                                ...
                                ) : 'Register to Scholaris'}
                            </motion.button>
                        </form>

                        <p style={{ fontFamily: 'Lora, serif' }} className="text-xs text-center text-[#adb3b4] font-medium pt-4">
                            Already have an account?{' '}
                            <Link to="/login" className="text-[#2d3435] font-bold hover:text-[#b32839] underline underline-offset-4 transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </motion.div>
