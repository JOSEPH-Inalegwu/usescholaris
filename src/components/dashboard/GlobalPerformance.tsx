      ...
      <div className="text-center mb-8">
        ...
        <div className="relative inline-flex items-center justify-center">
          <svg className="w-40 h-40 transform -rotate-90">
            ...
            <circle className="text-[#b32839]" cx="80" cy="80" fill="transparent" r="70" stroke="currentColor" strokeDasharray="440" strokeDashoffset="110" strokeWidth="6" />
          </svg>
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-4xl font-black text-[#2d3435] font-['Lora']">8.4</span>
            <span className="text-[10px] font-bold text-[#5a6061] uppercase tracking-widest font-['Lora']">Global Rank</span>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-2 gap-4 pt-6 border-t border-[#ebeeef]">
        <div className="text-center">
          <p className="text-[10px] font-bold text-[#5a6061] uppercase mb-1 font-['Lora']">Scholar Points</p>
          <div className="flex items-center justify-center gap-1">
            <span className="material-symbols-outlined text-[#b32839] text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>stars</span>
            <span className="font-bold text-[#2d3435] font-['Lora']">12,450</span>
          </div>
        </div>
        <div className="text-center">
